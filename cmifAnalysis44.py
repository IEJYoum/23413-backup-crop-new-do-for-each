...
def clauto(df,obs,dfxy):
    ...
    for i,ch in enumerate(chs):
        ...
        x,aobs,xx = autotype(adf,aobs,axy,chanT=False,name=obs.columns[ch]+"cluster autotype",res=0.75)
        print(obs.shape)
...
def leiden(df,obs,dfxy):
    ...
    PROCESS.append("Leiden_res_"+str(res))
    return(df,obs,dfxy)
